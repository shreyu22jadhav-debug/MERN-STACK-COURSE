  ...
  const getDashboardData = async () => {
    try {
      ...
      const apiResponse = await axios.get(
        ...
        {
          headers: {
            "x-auth-token": token   // send token so backend knows who is logged in
      ...
      // Save data in state to show on screen
        ...
        <div className="col-md-4 mb-3">
          <div className="card text-center shadow">
            <div className="card-body">
              ...
              {/* Show count from API, show 0 while loading */}
